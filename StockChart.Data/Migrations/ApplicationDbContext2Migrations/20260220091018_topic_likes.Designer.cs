...
namespace StockChart.Data.Migrations.ApplicationDbContext2Migrations
{
    ...
    [Migration("20260220091018_topic_likes")]
    partial class topic_likes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StockChart.Model.BondSpec", b =>
                {
                    ...
                    b.ToTable("BondSpec", (string)null);
                });
            ...
            modelBuilder.Entity("StockChart.Model.FinancialStatementEntry", b =>
                {
                    ...
                    b.HasIndex("DictionaryId", "Standard", "Period", "MetricId", "Year")
                        .IsUnique();
            ...
            modelBuilder.Entity("StockChart.Model.FootprintFavoritesBoard", b =>
                {
                    b.Property<Guid>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("FootprintFavoritesBoards");
                });
            ...
            modelBuilder.Entity("StockChart.Model.FutureSpec", b =>
                {
                    b.Property<int>("DictionaryId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("FutureSpec", (string)null);
                });
            ...
            modelBuilder.Entity("StockChart.Model.McpConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ProviderApiMode")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.Property<string>("ProviderLastResponseId")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");

                    b.Property<string>("ProviderStateJson")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("McpConversations", (string)null);
                });

            modelBuilder.Entity("StockChart.Model.McpConversationMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("McpConversationMessages", (string)null);
                });
            ...
            modelBuilder.Entity("StockChart.Model.MoexSecurityType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("MoexSecurityTypes", (string)null);
                });
            ...
            modelBuilder.Entity("StockChart.Model.SecurityLink", b =>
                {
                    b.Property<int>("FromDictionaryId")
                        .HasColumnType("int");

                    b.Property<int>("ToDictionaryId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("FromDictionaryId", "ToDictionaryId", "LinkType");

                    b.HasIndex("ToDictionaryId");

                    b.ToTable("SecurityLink", (string)null);
                });
            ...
            modelBuilder.Entity("StockChart.Model.TopicLike", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TopicLike", (string)null);
                });
            ...
            modelBuilder.Entity("StockChart.Model.UnderlyingMap", b =>
                {
                    b.Property<string>("AssetCode")
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)");

                    b.Property<string>("SpotSecId")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)");
                    ...
                    b.HasIndex("SpotSecId");

                    b.ToTable("UnderlyingMap", (string)null);
                });
            ...
            modelBuilder.Entity("StockChart.Model.BondSpec", b =>
                {
                    b.HasOne("StockChart.Model.Dictionary", "Dictionary")
                        .WithOne()
                        .HasForeignKey("StockChart.Model.BondSpec", "DictionaryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("StockChart.Model.FinancialStatementEntry", b =>
                {
                    ...
                    b.HasOne("StockChart.Model.FinancialStatementDictionary", "Metric")
                        .WithMany("Entries")
            ...
            modelBuilder.Entity("StockChart.Model.FutureSpec", b =>
                {
                    b.HasOne("StockChart.Model.Dictionary", "Dictionary")
                        .WithOne()
                        .HasForeignKey("StockChart.Model.FutureSpec", "DictionaryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("StockChart.Model.McpConversationMessage", b =>
                {
                    b.HasOne("StockChart.Model.McpConversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("StockChart.Model.SecurityLink", b =>
                {
                    b.HasOne("StockChart.Model.Dictionary", "FromDictionary")
                        .WithMany()
                        .HasForeignKey("FromDictionaryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_SecurityLink_Dictionary_From");

                    b.HasOne("StockChart.Model.Dictionary", "ToDictionary")
                        .WithMany()
                        .HasForeignKey("ToDictionaryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_SecurityLink_Dictionary_To");

                    b.Navigation("FromDictionary");

                    b.Navigation("ToDictionary");
                });
