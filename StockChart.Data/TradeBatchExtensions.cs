...
{
    public static async Task InsertTradesBatchAsync(this ApplicationDbContext context, IEnumerable<Trade> trades)
    {
...
WITH(
    ...
    public static async Task InsertTradesBinanceBatchAsync(this ApplicationDbContext context, IEnumerable<Tradesbinance> trades)
    {
        ArgumentNullException.ThrowIfNull(context);
        ArgumentNullException.ThrowIfNull(trades);
