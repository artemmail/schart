...
namespace StockChart.Migrations.ApplicationDbContext2Migrations
{
    ...
    [Migration("20230508110304_loginhistory")]
            ...
            modelBuilder.Entity("StockChart.Model.SelectedChartSettings", b =>
                {
                    ...
                    b.HasOne("StockChart.Model.ApplicationUser", "User")
                        .WithOne("SelectedChartSettings")
                        .HasForeignKey("StockChart.Model.SelectedChartSettings", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("StockChart.Model.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("SelectedChartSettings")
                        .IsRequired();
