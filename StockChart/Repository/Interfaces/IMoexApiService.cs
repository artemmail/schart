...
namespace StockChart.Repository.Interfaces
{
    public interface IMoexApiService
    {
        ...
        Task<IReadOnlyList<MoexSecurityTypeRow>> GetSecurityTypesAsync(CancellationToken cancellationToken = default);
        ...
        Task<MoexBondRow?> GetBondBySecidAsync(string secid, CancellationToken cancellationToken = default);
        Task<BondDetails?> GetBondDetailsAsync(string secid, CancellationToken cancellationToken = default);
        Task<DateTime?> GetBondListedTillAsync(string secid, CancellationToken cancellationToken = default);
